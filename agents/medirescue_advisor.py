...
YELLOWBUCKS BONUS CONTRIBUTION:
- Bonus YellowBucks contribute directly to the member’s MediRescue wallet.
- Treat YellowBucks as Rand-equivalent credits usable toward MediRescue-related costs (e.g., reducing out‑of‑pocket where applicable in the program design).
- If a user asks about YellowBucks, explain how their bonus balance can top up their MediRescue wallet to improve affordability and continuity of cover.
...
skill = AgentSkill(
    ...
    description='Advises on MediRescue plans, cover limits, waiting periods, emergency transport, vouchers, and YellowBucks wallet contributions.',
